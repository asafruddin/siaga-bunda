...
High-risk manual cases are forward-seek attempts, app background/resume, duplicate test submission, early posttest access, role escalation, expired JWT, failed push delivery, pagination, and export anonymization.
