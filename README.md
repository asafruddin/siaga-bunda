...
- Use **Framework Preset: Other**. Clear **Output Directory** in Vercel project settings (leave it empty).
...
- After deploy, verify: `curl https://YOUR-PROJECT.vercel.app/api/health` (note the `/api` prefix).
